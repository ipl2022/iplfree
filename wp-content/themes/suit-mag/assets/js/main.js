...
+function ($) {
  ...
  function updateClock() {
    ...
    $("#suitmag-digital-clock").html(currentTimeString);
  }
  ...
  $(document).on('added_to_cart', function (e, fragments) {
    var $new_cart = $('.suitmag-navigation-n-options .cart-icon span').text(fragments['total-cart-items']);
  });
  jQuery(document).on('click', '.mr-mobile-menu ul li:not(".menu-item-has-children") a', function () {
    jQuery('button#mr-close').trigger('click');
  });
  $(window).load(function () {
    $('.suitmag-trending-news ul').marquee({
      speed: 50,
      gap: 0,
      delayBeforeStart: 0,
      direction: 'left',
  ...
  var Starter = /*#__PURE__*/function () {
    ...
    _createClass(Starter, [{
      ...
      value: function toggleSearchWithOverlay() {
        ...
        var $searchToggler = $('.suitmag-toggle-search');
        var className = 'suitmag-search-opened';
        var $searchInput = $('.suitmag-header-search .search-field');
        /* Overlay */

        var overlayClassName = 'suitmag-search-overlay';
        ...
        var toggleSearech = function toggleSearech() {
          ...
          if (_this2.$body.hasClass(className)) {
            ...
            $('.suitmag-header-icons .suitmag-toggle-search').focus();
          }
        };
