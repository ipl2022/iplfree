...
<section id="primary" class="content-area">
	<main id="main" class="site-main container">
		<div class="error-404 not-found">
			<h1><?php echo esc_html__( 'Oops!', 'suit-mag' ) ?></h1>
			<p><?php echo esc_html__( 'This page doesn\'t seem to exist.', 'suit-mag' ) ?></p>
			...
			<div>
				<p><?php esc_html_e( 'It looks like the link pointing here was faulty. Maybe try searching?', 'suit-mag' ) ?></p>
				<?php get_search_form(); ?>
				<a href="<?php echo esc_url( home_url( '/' ) ) ?>" 
					class="<?php echo esc_attr( Suit_Mag_Helper::with_prefix( 'btn-primary' ) ); ?>">
					<?php echo esc_html__( 'Goto Homepage', 'suit-mag' ) ?>
