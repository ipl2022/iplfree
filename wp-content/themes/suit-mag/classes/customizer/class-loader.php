...
class Suit_Mag_Customizer_Loader extends Suit_Mag_Helper{
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'suitmagColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
...
new Suit_Mag_Customizer_Loader();
