...
if( !class_exists( 'Suit_Mag_Customizer_Dimensions_Integration' ) ){

	class Suit_Mag_Customizer_Dimensions_Integration extends Suit_Mag_Customizer{
		...
		public static $type = 'suit-mag-dimensions';

		public static $class = 'Suit_Mag_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'suit-mag' );
	...
	new Suit_Mag_Customizer_Dimensions_Integration();
}
