...
class Suit_Mag_Customizer_Dimensions_Control extends WP_Customize_Control {
	 ...
	 * @package Suit Mag WordPress Theme
	 */
	public $type = 'suit-mag-dimensions';
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'suit-mag' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-suit-mag-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'suit-mag' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'suit-mag' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'suit-mag' ),
			'desktop_left' 		=> esc_html__( 'Left', 'suit-mag' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'suit-mag' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'suit-mag' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'suit-mag' ),
			'tablet_left' 		=> esc_html__( 'Left', 'suit-mag' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'suit-mag' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'suit-mag' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'suit-mag' ),
			'mobile_left' 		=> esc_html__( 'Left', 'suit-mag' 	),
		);
		if ( false === $id ) {
