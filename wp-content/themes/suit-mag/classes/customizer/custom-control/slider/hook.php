 ...
 */
if( !class_exists( 'Suit_Mag_Customizer_Slider_Integration' ) ){
	class Suit_Mag_Customizer_Slider_Integration extends Suit_Mag_Customizer{
		 ...
		 * @package Suit Mag WordPress Theme
		 */
		public static $type = 'suit-mag-slider';

		public static $class = 'Suit_Mag_Customizer_Slider_Control';
	...
	new Suit_Mag_Customizer_Slider_Integration();
}