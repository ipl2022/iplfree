...
* @since 1.0.0
*
* @package Suitmag WordPress
*/

if ( class_exists( 'WP_Customize_Control' ) ) :

    class Suit_Mag_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( Suit_Mag_Helper::with_prefix( 'customize-js' ), 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'suit-mag' )
            ));
        }
...
Suit_Mag_Customizer::add_custom_control( array(
    'type'     => 'suit-mag-reset',
    'class'    => 'Suit_Mag_Customizer_Reset',
    'sanitize' => false,
