<?php
/**
 * Customizer Control: suit-mag-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class Suit_Mag_Customizer_Buttonset_Control extends WP_Customize_Control {
		 ...
		 * @package Suit Mag WordPress Theme
		 */
		public $type = 'suit-mag-buttonset';
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="suit-mag-buttonset">
...
Suit_Mag_Customizer::add_custom_control( array(
    ...
    'class'    => 'Suit_Mag_Customizer_Buttonset_Control',
