...
<section class="no-results not-found">
	...
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'suit-mag' ); ?></h1>
	</header><!-- .page-header -->
		...
		<div class="page-content">
			...
			<?php
				printf(
					...
					esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords or you can add post.', 'suit-mag' ),
					esc_url( admin_url( 'post-new.php' ) ),
					esc_html__( 'Get Started Here', 'suit-mag' )
				)
			?>
		</div><!-- .page-content -->
	<?php else: ?>
		<div class="page-content">
			<?php get_search_form();
				printf(
					'<p>%1$s</p> ',
					esc_html__( 'We can\'t seem to find any result that match your search key.', 'suit-mag' ),
					esc_url( admin_url( 'post-new.php' ) )
				)
			?>
		</div><!-- .page-content -->
		<div>
			<a href="<?php echo esc_url( home_url( '/' ) ) ?>" class="suitmag-btn-primary"><?php echo esc_html__( 'Go To Homepage', 'suit-mag' ) ?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
		</div>
	<?php endif; ?>
</section><!-- .no-results -->